...
function Start () {
	renderTexture = new Texture2D(GetComponent.<Camera>().pixelWidth, GetComponent.<Camera>().pixelHeight, TextureFormat.RGB24, false);
...
function OnPostRender() {
	...
	renderTexture.Resize(GetComponent.<Camera>().pixelWidth, GetComponent.<Camera>().pixelHeight, TextureFormat.RGB24, false);
	renderTexture.ReadPixels(Rect(GetComponent.<Camera>().pixelRect), 0, 0);
	renderTexture.Apply();
}